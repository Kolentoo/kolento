import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as i,o as p,c as l,a as n,b as s,d as c,f as a}from"./app-9fd1b0fe.js";const o={},u=a(`<h1 id="油猴脚本开发" tabindex="-1"><a class="header-anchor" href="#油猴脚本开发" aria-hidden="true">#</a> 油猴脚本开发</h1><h2 id="初始化配置" tabindex="-1"><a class="header-anchor" href="#初始化配置" aria-hidden="true">#</a> 初始化配置</h2><h4 id="主要配置" tabindex="-1"><a class="header-anchor" href="#主要配置" aria-hidden="true">#</a> 主要配置</h4><ul><li><strong>@name</strong>：用于设置脚本的名称</li><li><strong>@description</strong>：用于设置脚本的描述</li><li><strong>@author</strong>：用于设置作者信息</li><li><strong>@match</strong>：用于设置匹配的网站，这个最重要</li></ul><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// ==UserScript==</span>
