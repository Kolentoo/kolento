import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{r as i,o as l,c as d,a as e,b as n,d as t,f as r}from"./app-73a26bd1.js";const o={},c=e("h1",{id:"vuepress2-x",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#vuepress2-x","aria-hidden":"true"},"#"),n(" VuePress2.x")],-1),u=e("h2",{id:"简介",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#简介","aria-hidden":"true"},"#"),n(" 简介")],-1),p={href:"https://v2.vuepress.vuejs.org/zh/",target:"_blank",rel:"noopener noreferrer"},v=e("br",null,null,-1),m=e("code",null,"VuePress v2",-1),b=e("br",null,null,-1),h=e("br",null,null,-1),g=r(`<h4 id="版本" tabindex="-1"><a class="header-anchor" href="#版本" aria-hidden="true">#</a> 版本</h4><blockquote><p>本文档使用v2.0.0-beat63 版本<br><strong>前提条件</strong><br><strong>Node.js&gt;= 16.9.0+</strong><br></p></blockquote><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><ul><li>步骤 1: 创建并进入一个新目录</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>mkdir vuepress
cd vuepress
...
---
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,38);function x(k,f){const s=i("ExternalLinkIcon");return l(),d("div",null,[c,u,e("p",null,[e("a",p,[n("VuePress2.x官方文档地址"),t(s)]),v,m,n(" 目前仍处于 beta 阶段，各个版本之间更新后 API 的变动可能会比较大。"),b,n(" 本篇文章仅记录比较常用的内容，更多内容请阅读官网文档。"),h]),g])}const y=a(o,[["render",x],["__file","index.html.vue"]]);export{y as default};
